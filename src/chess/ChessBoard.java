...
/**
 * Constructor for the ChessBoard class, establishes initial layout and the location of pieces on the board.
 * 
...
public class ChessBoard implements ChessInterface {
	...
	/**
	 * This method determines if the game is over by checking if the King is
	 * in check on every side.
	 * 
	...
	/**
	 *Method to determine if the piece is able to move where the user wants it to.
	 *
	 * @param move a movement stored with a from and to location for both row and column 
	 * (non-Javadoc)
	 * @see chess.ChessInterface#isValidMove(chess.Move)
	 * @return valid
	 */
	 ...
	 * 
	 * @param move
	 *            which holds the position values for each button
	 */
	...
	/**
	 * Determines the piece at the location provided
	 * 
	 * @param row a row location for the piece
	 * @param column a column location for the piece
