		...
		if (board[move.fromRow][move.fromColumn].player() == Player.WHITE) {
			...
			if (board[move.toRow][move.toColumn] != null) {
				if (board[move.fromRow][move.fromColumn].player() != board[move.toRow][move.toColumn].player()) {
					if (board[move.fromRow][move.fromColumn] == board[move.fromRow][6]
							&& board[move.toRow][move.toColumn] == board[move.toRow][7]) {
						if (board[move.fromRow][move.fromColumn] == null) {
							valid = false;
						} else if (board[move.fromRow][move.fromColumn].player() != board[move.toRow][move.toColumn]
								.player()) {
							valid = true;
						} else if (board[move.fromRow][move.fromColumn].player() == board[move.toRow][move.toColumn]
								.player()) {
		...
		// Check if player is BLACK
			...
			if (board[move.toRow][move.toColumn] != null) {
				if (board[move.fromRow][move.fromColumn].player() != board[move.toRow][move.toColumn].player()) {
					...
					if (board[move.fromRow][move.fromColumn] == board[move.toRow - 1][move.toColumn + 1]
							|| board[move.fromRow][move.fromColumn] == board[move.toRow - 1][move.toColumn - 1]) {
						if (board[move.fromRow][move.fromColumn] == null) {
							valid = false;
						} else if (board[move.fromRow][move.fromColumn].player() != board[move.toRow][move.toColumn]
