...
//				else if (board[move.fromRow + 1][move.fromColumn].player() != board[move.fromRow][move.fromColumn].player()) {
//					valid = false;
//				}
//				else if (board[move.fromRow + 1][move.fromColumn].player() == board[move.fromRow][move.fromColumn].player()) {
//					valid = false;
...
//				}
			...
			if (board[move.fromRow][move.fromColumn] == board[1][move.fromColumn]) {
